...
const defaultSettings = {
  creatorAvatarUrl: "/fabicone.png",
  creatorName: "Crevo Store",
  heroCarouselStyle: "style2", // "style1" (Convex Arch) | "style2" (Concave Panoramic Arc)
  ...
  // Special Celebration Day Promo & Confetti Event
  specialPromoEnabled: false,
  specialPromoOccasion: "🎂 Special Celebration Day!",
  specialPromoHeading: "Exclusive Celebration Discount",
  specialPromoReason: "Today is a special milestone for Crevo Store! Enjoy an exclusive discount across our entire catalog.",
  specialPromoCode: "SPECIAL50",
  specialPromoDiscount: "50% OFF",
  specialPromoConfetti: true,
