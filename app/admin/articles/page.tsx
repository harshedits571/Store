            ...
            {!articles || articles.length === 0 ? (
              ...
              articles.map((article) => (
                <tr key={article.id} style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                  ...
                  <td style={{ padding: '16px' }}>
                    <Link href={`/admin/articles/edit/${article.id}`} className="btn-secondary" style={{ padding: '4px 12px', fontSize: '0.75rem', marginRight: '8px', textDecoration: 'none' }}>Edit</Link>
